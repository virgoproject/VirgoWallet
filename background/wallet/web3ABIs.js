...
const ERC721_ABI = [
    // Constructeur de contrat ERC-721
    {
        "inputs": [
            {
                "internalType": "string",
    ...
    {
        "inputs": [],
        "name": "TransferStakingTokenNotAllowed",
        "type": "error"
    },
    // Événements
    {
    ...
    // Fonction pour récupérer le solde de NFTs d'un propriétaire
    {
        "name": "balanceOf",
        "inputs": [
            {
    ...
    // Fonction pour brûler un NFT donné
    {
        "name": "burn",
        "inputs": [
            {
    ...
    // Fonction pour brûler plusieurs NFTs en une seule transaction
    {
        "name": "burnBatch",
        "inputs": [
            {
    ...
    // Fonction pour récupérer le propriétaire d'un NFT donné
    {
        "name": "ownerOf",
        "inputs": [
            {
    ...
    // Fonction pour récupérer la collection de NFTs d'un propriétaire spécifique en utilisant son adresse
    {
